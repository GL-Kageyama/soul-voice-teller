...
With 17 skills — five (`writer-persona` reflecting the writer's (human's) soul, voice, and preferences, `premise` for ideation, `plot-design` for design, `fast-draft` for the draft, `voice-ledger` for storing the voice), seven optional preparations, and five for prose style · revision · the ledger — the layer makes "design → draft → revision" hold up on writing skills alone.
...
- [The 17 skills](docs/skills.md) — the reference of what each skill does (input → output)
...
- `skills/{name}/SKILL.md` — the 17 skills (en canonical) + `SKILL-ja.md` / `SKILL-zh.md` per language
