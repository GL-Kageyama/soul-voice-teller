...
5. **persona の魂の物語を理由として書かない**——傷・決着のついていない問いは背後の源としてのみ用い、草稿に「〜年前に…」と書き込まない。**源は持つが、源を語らない**（E2b n=2: **未実証の安全弁**。魂への効果は確認されず、実質は4条の「名指ししない」と重なるが、涙の装置化を防ぐ安全弁として残す）。

混ざっていたら書き直す。「説明・名指し・総括」は**捏造された感傷（魂を壊す）と凡庸さ（個別性を壊す）の二重の害**（E5）。「源を涙の装置として語る」ことは4条（名指ししない）が禁じる（E2b n=2 では、事実として源に触れるだけなら魂を壊さなかった）。
