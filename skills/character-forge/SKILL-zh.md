...
2b. 定下人物的**角色**（role）——其在故事中*做*什么（没有角色的人物不会行动；只有核心仍是静止的）：
    ...
    - **挑战**（所对抗之物）：两个要素——且能动动词的主语始终是**主角**，而非敌人：
        1. **敌人（指名）**：所对抗的是谁/什么。指名道姓（是具体的对手，而非含糊的「组织」）。
        2. **敌人的抵抗（作为回应、分阶段）**：随着主角的追究加深，敌人的抵抗逐步逼近——制止 → 拒绝 → 威压 → 最终对峙。这一抵抗是敌人对主角追究的*回应*，而非敌人自己的主动发起。最终对峙放在高潮（追究到达之处），而非故事中段。
        主角的追究本身（调查 · 揭发 · 摊牌）由能动原理与场景表承担，不写在此处。不要把敌人写成能动的主语（「敌人施加压力」）——那会把主角转化为「对压力的回应」，摧毁自律性（V6 实测 -6/-24/-10）。
