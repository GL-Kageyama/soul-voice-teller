...
| `steady-draft` | continue the ongoing work — write the next episode, or flesh out / expand an episode, grounded in persona + design + ledger + previous drafts | persona + design + ledger + previous drafts → `<work>/草稿/draft_XX-Y_話名.md` + ledger update + voices for the store |
