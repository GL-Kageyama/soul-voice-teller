...
/fast-draft            # write the first draft (introspection loop + the aesthetic of expression and restraint)
/steady-draft          # continue the work — write the next episode, or flesh out / expand an episode (persona + design + ledger)
